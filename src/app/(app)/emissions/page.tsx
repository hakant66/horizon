...
export default async function EmissionsPage() {
  ...
  if (!reportingPeriod) {
    return <EmptyState title="No reporting period" description="Create one in Setup to run emissions calculations." />;
  }
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Emissions" description="Calculate and review Scope 1 and Scope 2 emissions with transparent formulas." />
      <EmissionsClient
